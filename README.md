...
The UMD module is available from this repository (see the `dist/umd` folder), or from CDNs such as [jsdelivr](https://www.jsdelivr.com/package/npm/svg-exportjs-browser).
